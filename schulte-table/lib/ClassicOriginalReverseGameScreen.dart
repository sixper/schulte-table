...
class ClassicOriginalReverseGame extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: ClassicOriginalReverseGameScreen(),
    );
  }
}

class ClassicOriginalReverseGameScreen extends StatefulWidget {
  @override
  _ClassicOriginalReverseGameScreen createState() =>
      _ClassicOriginalReverseGameScreen();
}

class _ClassicOriginalReverseGameScreen
    extends State<ClassicOriginalReverseGameScreen> {
  @override
  Widget build(BuildContext context) {
    return myTable();
  }
  ...
  void isEnd(int check) {
    if (check == 0) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => ClassicOriginalReverseFinal()));
    }
  }
