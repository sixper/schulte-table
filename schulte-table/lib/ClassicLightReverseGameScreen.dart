...
class ClassicLightReverseGame extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: ClassicLightReverseGameScreen(),
    );
  }
}

class ClassicLightReverseGameScreen extends StatefulWidget {
  @override
  _ClassicLightReverseGameScreen createState() =>
      _ClassicLightReverseGameScreen();
}

class _ClassicLightReverseGameScreen
    extends State<ClassicLightReverseGameScreen> {
  @override
  Widget build(BuildContext context) {
    return myTable();
  }
  ...
  void isEnd(int check) {
    if (check == 0) {
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => ClassicLightReverseFinal()));
    }
  }
